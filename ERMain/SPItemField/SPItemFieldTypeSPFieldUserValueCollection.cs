...
namespace ListsNotifications
{
    class SPItemFieldTypeSPFieldUserValueCollection : SPItemField
    {
        ...
        public override void GetFriendlyFieldValues(string fieldValueString, out string friendlyFieldValue)
        {
            ...
            List<SPPrincipal> fieldPrincipals = valueAfterParam ? 
                Item.GetUsersFromUsersFieldsAfter(new List<string> { FieldTitle }) : 
                Item.listItem.GetUsersFromUsersFields(new List<string> { FieldTitle });
