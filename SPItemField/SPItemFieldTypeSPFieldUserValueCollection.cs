...
namespace ListsNotifications
{
    ...
    {
        public SPItemFieldTypeSPFieldUserValueCollection(ERItem itemParam, string fieldTitleParam, bool valueAfterParam = true) : base(itemParam, fieldTitleParam, valueAfterParam)
        {
